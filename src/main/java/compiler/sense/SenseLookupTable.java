 ...
 * 
 */
public class SenseLookupTable extends AbstractLookupTable {


	public SenseLookupTable(SenseGrammar g) {
		super(g,1000);
	 ...
	 * @param rowsCount
	 */
	public SenseLookupTable(SenseGrammar g, InputStream stream ) {
		super(g,1000);
		
		loadTable(g,stream);
		
	}
	private void loadTable(SenseGrammar g, 	InputStream stream ) {
