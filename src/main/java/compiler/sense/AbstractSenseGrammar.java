...
public abstract class AbstractSenseGrammar extends AbstractGrammar {
	...
	protected NonTerminal defineGrammar() {
		...
		unit.setRule(packageDeclaration.add(importDeclarations).add(typeDeclarations).or(packageDeclaration.add(typeDeclarations)));
		...
		constantDeclaration.setRule(annotations.add(type).add(variableName).add(Terminal.of(";")).or(type.add(variableName).add(Terminal.of(";"))).or(annotations.add(type).add(variableName).add(Terminal.of("=")).add(expression).add(Terminal.of(";")).or(type.add(variableName).add(Terminal.of("=")).add(expression).add(Terminal.of(";")))));
		abstractMethodDeclaration.setRule(annotations.add(returnType).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(";")).or(returnType.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).add(Terminal.of(";"))).or(annotations.add(returnType).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(";")).or(returnType.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).add(Terminal.of(";")))));
		...
		methodHeader.setRule(annotations.add(returnType).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).or(returnType.add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")"))).or(annotations.add(returnType).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")).or(returnType.add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")")))));
