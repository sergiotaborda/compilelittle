...
NonTerminal maybeAnnotations = addNonTerminal(NonTerminal.of("maybeAnnotations"));
...
classDeclaration.setRule(maybeAnnotations.add(Terminal.of("class")).add(qualifiedName).add(genericTypesDeclaration).add(superDeclaration).add(classBody));
annotations.setRule(annotation.or(annotations.add(annotation)));
annotation.setRule(Terminal.of("public").or(Terminal.of("abstract").or(Terminal.of("final"))));
...
methodHeader.setRule(maybeAnnotations.add(returnType).add(Identifier.instance()).add(Terminal.of("(")).add(formalParameterList).add(Terminal.of(")")).or(maybeAnnotations.add(returnType).add(Identifier.instance()).add(Terminal.of("(")).add(Terminal.of(")"))));
...
maybeAnnotations.setRule(annotations.or(EmptyTerminal.instance()));
