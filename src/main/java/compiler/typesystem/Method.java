...
public class Method implements CallableMember {
	...
	private Map<String,CapturableTypeParameter> methodGenericTypes = new HashMap<>();
	...
	public void add(CapturableTypeParameter parameter){
		methodGenericTypes.put(parameter.getName(), parameter);
	}
