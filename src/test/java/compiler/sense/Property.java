...
public class Property {
	...
	public Property(String name, Method acessor, Method modifier){
		this.name = name;
	...
	public boolean equals(Object obj) {
		return (obj instanceof Property) && equalsProperty((Property)obj); 
	}

	private boolean equalsProperty(Property other) {
